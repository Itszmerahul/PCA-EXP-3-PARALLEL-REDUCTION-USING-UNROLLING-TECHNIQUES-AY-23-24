...
## RESULT:
Thus the program has been executed by unrolling by 8 and unrolling by 16. It is observed that unrolling16 has executed with less elapsed time than unrolling 8 with blocks512,512.
